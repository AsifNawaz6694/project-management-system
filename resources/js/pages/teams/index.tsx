    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
                        ...
                        <div className="flex flex-col items-center justify-center gap-3 p-16 text-center">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground mt-1 max-w-sm text-sm">
                                    {canManage
                                        ? 'Spin up your first team to organize people around projects or departments.'
                                        : 'A manager will set up teams here.'}
                                </p>
                            </div>
                            {canManage && (
                    ...
                    <section className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                        {teams.map((t) => (
                            <SoftCard key={t.id} className="group">
                                <div
                                    className={cn(
                                        'relative h-20 overflow-hidden rounded-t-2xl bg-gradient-to-br',
                                        COLOR_GRADIENT[t.color] ?? COLOR_GRADIENT.violet,
                                    )}
                                >
                                ...
                                <div className="-mt-7 flex flex-col gap-3 p-5 pt-0">
                                    ...
                                    <div>
                                        <Link
                                            ...
                                            className="font-display line-clamp-1 text-base font-bold tracking-tight hover:text-blue-600 dark:hover:text-blue-300"
                                        >
                                            {t.name}
                                        </Link>
                                        {t.description && (
                                            <p className="text-muted-foreground mt-1 line-clamp-2 text-xs leading-relaxed">{t.description}</p>
                                        )}
                                    </div>
                                    ...
                                    <div className="border-border/60 flex items-center justify-between border-t pt-3">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <Button asChild size="sm" variant="ghost">
                                                <Link href={route('teams.show', t.slug)}>View</Link>
                                            </Button>
                                            {canManage && (
                                                <Button
                                                    onClick={() => setConfirmDeleteSlug(t.slug)}
                                                    variant="ghost"
                                                    size="icon"
            ...
            <ConfirmDialog
                ...
                description={
                    teamToDelete && teamToDelete.members_count > 0
