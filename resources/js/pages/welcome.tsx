            ...
            <div className="relative min-h-dvh overflow-hidden">
                ...
                <main className="mx-auto max-w-4xl px-6 py-20 text-center">
                    <span className="text-muted-foreground bg-card shadow-soft-xs ring-border/60 inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-medium ring-1">
                        <Sparkles className="size-3 text-violet-500" /> Enterprise project management, beautifully crafted
                    </span>
                    <h1 className="font-display mt-6 text-5xl font-bold leading-[1.05] tracking-tight md:text-6xl">
                        ...
                        <br className="hidden md:block" /> projects, and people.
                    </h1>
                    <p className="text-muted-foreground mx-auto mt-6 max-w-xl text-base leading-relaxed">
                        Built with strict role-based access, two-factor authentication, and a premium experience inspired by Linear, Notion, and Asana.
                    </p>
                    ...
                    <div className="mt-20 grid gap-4 text-left md:grid-cols-3">
                        {[
                            { icon: ShieldCheck, title: 'Email 2FA', body: 'Every sign-in is verified with a 6-digit code, expiring after 10 minutes.', tone: 'from-violet-500 to-indigo-600' },
                            { icon: Users, title: 'Role-based access', body: 'Admin, Manager, Employee — each tuned to the exact permissions they need.', tone: 'from-emerald-500 to-teal-600' },
                            { icon: Sparkles, title: 'Modular by design', body: 'Drop new modules in without rewiring permissions or navigation.', tone: 'from-pink-500 to-fuchsia-600' },
                        ].map((f) => (
                            <div key={f.title} className="bg-card shadow-soft-sm ring-border/60 hover:shadow-soft-md ring-1 rounded-2xl p-5 transition-all">
                                <div className={`flex size-10 items-center justify-center rounded-xl bg-gradient-to-br ${f.tone} text-white shadow-soft-sm`}>
